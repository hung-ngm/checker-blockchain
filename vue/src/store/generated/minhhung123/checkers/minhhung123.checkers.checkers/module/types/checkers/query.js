...
const baseQueryCanPlayMoveRequest = {
    idValue: "",
    player: "",
    fromX: 0,
    fromY: 0,
...
export class QueryClientImpl {
    ...
    NextGame(request) {
        ...
        const promise = this.rpc.request("minhhung123.checkers.checkers.Query", "NextGame", data);
    ...
    StoredGame(request) {
        ...
        const promise = this.rpc.request("minhhung123.checkers.checkers.Query", "StoredGame", data);
    ...
    StoredGameAll(request) {
        ...
        const promise = this.rpc.request("minhhung123.checkers.checkers.Query", "StoredGameAll", data);
    ...
    CanPlayMove(request) {
        ...
        const promise = this.rpc.request("minhhung123.checkers.checkers.Query", "CanPlayMove", data);
