...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryCanPlayMove = (
    ...
    this.request<CheckersQueryCanPlayMoveResponse, RpcStatus>({
      path: `/minhhung123/checkers/checkers/canPlayMove`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/minhhung123/checkers/checkers/nextGame
   */
  queryNextGame = (params: RequestParams = {}) =>
    this.request<CheckersQueryGetNextGameResponse, RpcStatus>({
      path: `/minhhung123/checkers/checkers/nextGame`,
      method: "GET",
      format: "json",
      ...params,
    });
   ...
   * @request GET:/minhhung123/checkers/checkers/storedGame
   */
  queryStoredGameAll = (
    query?: {
    ...
    this.request<CheckersQueryAllStoredGameResponse, RpcStatus>({
      path: `/minhhung123/checkers/checkers/storedGame`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   * @request GET:/minhhung123/checkers/checkers/storedGame/{index}
   */
  queryStoredGame = (index: string, params: RequestParams = {}) =>
    this.request<CheckersQueryGetStoredGameResponse, RpcStatus>({
      path: `/minhhung123/checkers/checkers/storedGame/${index}`,
      method: "GET",
      format: "json",
      ...params,
    });
